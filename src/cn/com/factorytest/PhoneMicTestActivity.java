...
public class PhoneMicTestActivity extends Activity implements OnClickListener {
  ...
  public PhoneMicTestActivity() { this.mHandler = new MyHandler(); }
  ...
  protected void onResume() {
    ...
    int maxVolume =
        this.mAudioManager.getStreamMaxVolume(AudioManager.STREAM_MUSIC);
    this.mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, maxVolume, 0);
