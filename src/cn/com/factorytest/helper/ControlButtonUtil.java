...
public class ControlButtonUtil {
  ...
  public ControlButtonUtil(Activity paramActivity) {
    resultIntent.removeExtra(MainActivity.EXTRA_TEST_RESULT_INFO);
    ...
    skipButton.setOnClickListener(new Button.OnClickListener() {
      public void onClick(View v) {
        ...
        //						resultIntent);
        //				if (ControlButtonUtil.mNotificationManager
        //!= null)
        // ControlButtonUtil.mNotificationManager.cancelAll();
        //				ControlButtonUtil.mActivity.finish();
  ...
  public static void setIntent(String result) { mAction = result; }
  public static void setResult(String result) {
    resultIntent.putExtra(MainActivity.EXTRA_TEST_RESULT_INFO, result);
  }
