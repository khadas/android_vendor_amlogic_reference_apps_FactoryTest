...
public abstract class SerialHelper {
  ...
  private boolean _factoryTestFlag = false;
  //----------------------------------------------------
  ...
  public SerialHelper() { this("/dev/ttyS4", 115200); }

  public SerialHelper(String sPort) { this(sPort, 115200); }
  ...
  //----------------------------------------------------
  public void setfactoryTestFlag() { this._factoryTestFlag = true; }
  //----------------------------------------------------
