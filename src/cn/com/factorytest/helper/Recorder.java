...
public class Recorder
  ...
  private static final String TEST_FILE_PATH = "/data/data/cn.com.factorytest/"
                                               + "test";
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer) { stop(); }
  ...
  public File sampleFile() { return this.mSampleFile; }

  public int sampleLength() { return this.mSampleLength; }
  ...
  public int state() { return this.mState; }
  ...
  public void stopRecording() {
    ...
    this.mSampleLength =
        (int)((System.currentTimeMillis() - mSampleStart) / 1000L);
    setState(Recorder.IDLE_STATE);
  }
}
